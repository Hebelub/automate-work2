...
const mockJiraTasks: JiraTask[] = [
  {
    ...
    status: "In Progress",
    issueType: "Story",
    issueTypeIconUrl: "https://company.atlassian.net/secure/viewavatar?size=xsmall&avatarId=10315&avatarType=issuetype",
    isInSprint: true,
    assignee: "John Doe",
    priority: "High",
    priorityIconUrl: "https://company.atlassian.net/images/icons/priorities/high.svg",
  ...
  },
  {
    ...
    status: "QA",
    issueType: "Task",
    issueTypeIconUrl: "https://company.atlassian.net/secure/viewavatar?size=xsmall&avatarId=10318&avatarType=issuetype",
    isInSprint: true,
    assignee: "Jane Smith",
    priority: "Medium",
    priorityIconUrl: "https://company.atlassian.net/images/icons/priorities/medium.svg",
  ...
  },
  {
    ...
    status: "Open",
    issueType: "Bug",
    issueTypeIconUrl: "https://company.atlassian.net/secure/viewavatar?size=xsmall&avatarId=10303&avatarType=issuetype",
    isInSprint: false,
    assignee: "Mike Johnson",
    priority: "Critical",
    priorityIconUrl: "https://company.atlassian.net/images/icons/priorities/critical.svg",
  ...
  },
  {
    ...
    priority: "Low",
    priorityIconUrl: "https://company.atlassian.net/images/icons/priorities/low.svg",
